...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/luazhizhan/ignitewasm/blog/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BlogQueryParamsResponse, RpcStatus>({
      path: `/luazhizhan/ignitewasm/blog/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/luazhizhan/ignitewasm/blog/posts
   */
  queryPosts = (
    query?: {
    ...
    this.request<BlogQueryPostsResponse, RpcStatus>({
      path: `/luazhizhan/ignitewasm/blog/posts`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
